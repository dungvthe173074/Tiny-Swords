...
public class MainMenuManager : MonoBehaviour
{
    ...
    private void DrawGuideModal()
    {
        ...
        string guideContent =
            ...
            "• 🎯 <b>Tháp Sniper (300G):</b> Tầm 15.0 (Siêu xa) • Tốc độ 0.2/s • Sát thương 500. <b>Chuyên diệt quái trâu & Boss</b>.\n\n" +
    ...
    private void DrawSettingsModal()
    {
        ...
        float modalH = Mathf.Min(290f, Screen.height - 30f);
        float modalX = centerX - modalW * 0.5f;
        float modalY = centerY - modalH * 0.5f;
        ...
        // SFX Volume
        GUI.Label(new Rect(optX, optY + 54f, optW, 22f), $"🔊  <b>Hiệu Ứng Âm Thanh (SFX):</b>  {(int)(sfxVolume * 100)}%", bodyStyle);
        sfxVolume = GUI.HorizontalSlider(new Rect(optX, optY + 78f, optW, 20f), sfxVolume, 0f, 1f);
